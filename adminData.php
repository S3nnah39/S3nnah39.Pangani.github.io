...
<html lang="en">
    ...
    <body>
        <div id="mainHeader">
            ...
            <span id="signIn"><a href="logIn.html" class="glyphicon glyphicon-user" onclick="alert('You are logged in')"></a></span>
        ...
        <div class="loadOption">
            <div id="container3">
                <div class="cardHolder">
                    ...
                    <div id="card2">
                        <a href="#" class="addStudent" onclick="openStudentForm()">Admit<br>Student</a>
                    </div>
                </div>
            </div>
        </div>
